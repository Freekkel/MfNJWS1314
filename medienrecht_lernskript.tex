...
\begin{document}
	...
	\mainmatter 
		...
		\input{mainmatter/meinungs_pressefreiheit}
		\input{mainmatter/allgemeines_persoenlichkeitsrecht}
		\input{mainmatter/presseordnungsrecht}
		\input{mainmatter/presserat}
		\input{mainmatter/ansprueche_gegen_presse}
		\input{mainmatter/urheberrecht}
	\backmatter
